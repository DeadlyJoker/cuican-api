...
func printHelp() {
	fmt.Println("Cuican-API(Based NewAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Based on: NewAPI by QuantumNous - https://github.com/QuantumNous/new-api")
	fmt.Println("Usage: cuican-api [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
